// GRS Virtual Player mission integration point.
// Safe defaults intentionally reject authoritative operations.
// Replace these methods in your mission integration layer.
