class RHD_ATAKMenuModel
{
	...
	static array<string> GetTabs() { return {TAB_SHOP, TAB_CASINO, TAB_MAP, TAB_STATS, TAB_HANDLER}; }
	static array<string> GetCasinoGames() { return {CASINO_BLACKJACK, CASINO_ROULETTE, CASINO_SCRATCH, CASINO_LOTTO}; }
	static array<string> GetHandlerActions() { return {HANDLER_RECRUIT, HANDLER_MORTAR, HANDLER_SUPPLY}; }
};
