class GRS_VirtualPlayerEasyConfig
{
	...
	// Shared shop/economy behavior.
	// All F6/F7/F8 transactions should use GRS_Shop rather than hard-coded
	// prices inside menu scripts.
	static const bool ENABLE_SHARED_SHOP = true;
	static const bool ALLOW_SHOP_SELLING = true;
	static const bool ALLOW_SHOP_BUYING = true;
